...
public class FluentWaiting extends InitMethod
{
	...
	{
		 FluentWait<WebDriver> SelectableWait = new FluentWait<WebDriver>(driver)
		            .withTimeout(TotalTimeInSeconds, TimeUnit.SECONDS)
		            .pollingEvery(PollingTimeInMilliseconds, TimeUnit.MILLISECONDS)
		            .ignoring(NoSuchElementException.class);
	...
	{
		 FluentWait<WebDriver> visibleWait = new FluentWait<WebDriver>(driver)
		            .withTimeout(TotalTimeInSeconds, TimeUnit.SECONDS)
		            .pollingEvery(PollingTimeInMilliseconds, TimeUnit.MILLISECONDS)
		            .ignoring(NoSuchElementException.class);
	...
	{
		 FluentWait<WebDriver> alertWait = new FluentWait<WebDriver>(driver)
		            .withTimeout(TotalTimeInSeconds, TimeUnit.SECONDS)
		            .pollingEvery(PollingTimeInMilliseconds, TimeUnit.MILLISECONDS)
		            .ignoring(NoSuchElementException.class);
	...
	{
		 FluentWait<WebDriver> titleWait = new FluentWait<WebDriver>(driver)
		            .withTimeout(TotalTimeInSeconds, TimeUnit.SECONDS)
		            .pollingEvery(PollingTimeInMilliseconds, TimeUnit.MILLISECONDS)
		            .ignoring(NoSuchElementException.class);
